...
;    ]
    ifelse WHO = 0 [
      set evaluation-period retailer-0-evaluation-period
      set price-change retailer-0-price-change
      set price retailer-0-initial-price
    ] [
      set evaluation-period retailer-1-evaluation-period
      set price-change retailer-1-price-change
    ...
    output-print ( word "Price Change: " price-change)
    output-print ( " " )
...
to evaluate-pricing-strategy
  ask retailers [
    if ticks mod (evaluation-period + 1) = 0 [
...
;        set price-change random-float 1
        set price precision (price + price-change) 2
      ]
      [
;        set old-price price
...
;        ]
        if (price - price-change) > unit-cost [
          set price precision (price - price-change) 2
        ]
      ]
    ]
;    show ( word "retailer " WHO " price: " price )
  ]
;  show ( word "market shares dis:" market-shares-list)
...
@#$#@#$#@
<experiments>
  <experiment name="S1_S1" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="S1_S2" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S1_S3" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S4" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S5" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S6" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S3_S1" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S3_S2" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S3_S3" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S3_S4" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S3_S5" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S1_S3_price_bis_2" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S1_S3_price_bis_6" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S1_S3_price_bis_10" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S3_price_bis_10" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S3_price_bis_6" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S3_price_bis_2" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S3_S3_price_bis_2" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S3_S3_price_bis_6" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S3_S3_price_bis_10" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S4_S3_price_bis_2" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S4_S3_price_bis_6" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S4_S3_price_bis_10" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S5_S3_price_bis_2" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S5_S3_price_bis_6" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S5_S3_price_bis_10" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S6_S3_price_bis_2" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S6_S3_price_bis_6" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S6_S3_price_bis_10" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S1_price_bis_2" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S1_price_bis_6" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S1_price_bis_10" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S2_price_bis_2" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S2_price_bis_6" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S2_price_bis_10" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S4_price_bis_2" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S4_price_bis_6" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S4_price_bis_10" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S5_price_bis_2" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S5_price_bis_6" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S5_price_bis_10" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S6_price_bis_2" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S6_price_bis_6" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
  ...
  <experiment name="S2_S6_price_bis_10" repetitions="4" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>[ cumulative-profit ] of retailer 0</metric>
